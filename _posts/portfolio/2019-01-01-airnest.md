...
On the back-end, in collaboration with the drone expert, I wrote Flight Log Parser that transformed some raw drone log files into consumable MongoDB records.
